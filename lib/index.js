...
var script = {
  ...
  computed: {
    ...
    propsChildren: function propsChildren() {
    ...
    setSelected: function setSelected() {
      ...
      if (this.multiple) {
        ...
        var selectedNode = treeFind(this.data, function (node) {
          return _this2.checkSelected(node[_this2.propsValue]);
        }, this.props);
...
var __vue_render__ = function __vue_render__() {
  ...
  return _c('div', {
    ...
    }], null, false, 1229176757)
  })], 1) : _c('p', {
    staticClass: "el-select-tree__empty",
    style: {
      width: _vm.minWidth + 'px'
    }
  }, [_vm._v("\n      Không có dữ liệu\n    ")]), _c('el-input', {
    ref: "reference",
    class: {
